...
export const ShortTextInput = (props: ShortTextInputProps) => {
  ...
  return (
    <textarea
      ref={props.ref}
      class="focus:outline-none bg-transparent px-4 py-4 w-[120%] flex-1 w-full h-full min-h-[56px] max-h-[128px] text-input disabled:opacity-50 disabled:cursor-not-allowed disabled:brightness-100 rounded-[50px] border border-red-500"
